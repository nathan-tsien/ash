...
| Companion Shadow LogoMark | `LogoMark` icon in `@ash/ui`, sidebar home mark, create-task home composer, assistant identity row, marketing/auth brand lockups, future favicon/app icon source | Cultivate; vector-only, no hand/face/generic AI icon |
