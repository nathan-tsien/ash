...
3. If changing layout or chrome color: **`docs/design-guidelines.md`** + **ADR-0013**.
...
| Palette / token drift | **`docs/design-guidelines.md`** + **ADR-0013** must stay in sync with `globals.css` |
